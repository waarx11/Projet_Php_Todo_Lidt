...
<section class="gradient-custom">
                    ...
                    <div class="card bg-dark text-white" style="border-radius: 1rem;">
                        <div class="card-body p-4 text-center">
                            ...
                            <div class="mb-md-5 mt-md-4 pb-5">
                                ...
                                <p>
                                    <?php if (isset($dVueEreur['userMailInvalide'])) { echo $dVueEreur['userMailInvalide']; } ?>
                                </p>
  ...
  <path d="M14.247 14.269c1.01 0 1.587-.857 1.587-2.025v-.21C15.834 10.43 14.64 9 12.52 9h-.035C10.42 9 9 10.36 9 12.432v.214C9 14.82 10.438 16 12.358 16h.044c.594 0 1.018-.074 1.237-.175v-.73c-.245.11-.673.18-1.18.18h-.044c-1.334 0-2.571-.788-2.571-2.655v-.157c0-1.657 1.058-2.724 2.64-2.724h.04c1.535 0 2.484 1.05 2.484 2.326v.118c0 .975-.324 1.39-.639 1.39-.232 0-.41-.148-.41-.42v-2.19h-.906v.569h-.03c-.084-.298-.368-.63-.954-.63-.778 0-1.259.555-1.259 1.4v.528c0 .892.49 1.434 1.26 1.434.471 0 .896-.227 1.014-.643h.043c.118.42.617.648 1.12.648Zm-2.453-1.588v-.227c0-.546.227-.791.573-.791.297 0 .572.192.572.708v.367c0 .573-.253.744-.564.744-.354 0-.581-.215-.581-.8Z"/>
                            ...
                            <div class="input-group mb-3">
                                <p>
                                    <?php if (isset($dVueEreur['userNameSignUpEmpty'])) { echo $dVueEreur['userNameSignUpEmpty']; } ?>
                                </p>
  ...
  <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4Zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10Z"/>
                            ...
                            <div class="input-group mb-3">
                                <p>
                                    <?php if (isset($dVueEreur['userIdSignUpEmpty'])) { echo $dVueEreur['userIdSignUpEmpty']; } ?>
                                </p>
  ...
  <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3Zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/>
                            ...
                            <div class="input-group mb-3">
                                <p>
                                    <?php if (isset($dVueEreur['paswordSignUpEmpty'])) { echo $dVueEreur['paswordSignUpEmpty'],"<br>"; } ?>
                                </p>
  ...
  <path d="M4 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/>
                                ...
                                <div class="input-group mb-3">
                                <p>
                                    <?php if (isset($dVueEreur['paswordSignUpNotEquals'])) { echo $dVueEreur['paswordSignUpNotEquals'],"<br>"; } ?>
                                </p>
