...
<section class="gradient-custom">
                ...
                <div class="card bg-dark text-white" style="border-radius: 1rem;">
                    ...
                    <div class="card-body p-4 text-center">
                        ...
                        <div class="mb-md-5 mt-md-4 pb-5">
                            ...
                            <?php if (isset($dvueError["loginError"])) {
                                echo '<div class="alert alert-danger" role="alert">'. $dvueError["loginError"].'</div>';
                            } ?>

                            <?php if (isset($dvueError['userNameEmpty']))
                            {
                                echo'<div class="alert alert-danger" role="alert">'. $dvueError["userNameEmpty"].'</div>';
                            } ?>
  ...
  <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4Zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10Z"/>
                            ...
                            <?php if (isset($dvueError['paswordEmpty'])) {
                                echo'<div class="alert alert-danger" role="alert">'. $dvueError["paswordEmpty"].'</div>';
                            } ?>
                            <div class="input-group mb-3">
